...
# ======================================================
di_first_years = "http://laurea.educ.di.unito.it/index.php/offerta-formativa/calendario/orari/orario-primi-anni?tipoLaurea={}&annoDiCorso={}&AA={}"      # Primi anni (1, 2)
di_third_year = "http://laurea.educ.di.unito.it/index.php/offerta-formativa/calendario/orari/orario-curriculum?tipoLaurea={}&corso={}&AA={}"              # Curricula terzo anno (3)
di_masterly = "http://magistrale.educ.di.unito.it/index.php/offerta-formativa/calendario/orari/orario-completo?tipoLaurea=M&completo=Magistrale&AA={}"    # Magistrale (4, 5)
